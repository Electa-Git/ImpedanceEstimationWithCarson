function solve_shunt_only_est(data, solver)
    _PMD.solve_mc_model(data, _PMD.IVRQuadraticENPowerModel, solver, build_shunt_only_est, multinetwork=true)
end
"""
Builder for impedance estimation with carson's equation
"""
function build_shunt_only_est(pm::_PMD.IVRQuadraticENPowerModel)
