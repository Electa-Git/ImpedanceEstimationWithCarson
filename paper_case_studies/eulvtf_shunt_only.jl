...
for power_mult in [2.]
    run_impedance_estimation_shunt_only_eulvtf_case(raw"C:\Users\mvanin\OneDrive - KU Leuven\Desktop\repos\DataDrivenImpedanceEstimationWithCarson\results_ma27/", ie_solver, pf_solver, profiles, timestep_set, add_meas_noise = true, power_mult=power_mult)
end

function run_impedance_estimation_shunt_only_eulvtf_case(result_path::String, ie_solver, pf_solver, profiles::_DF.DataFrame, timestep_set; scenario_id::Int = 1, add_meas_noise::Bool=true, power_mult::Float64=1.)    
    ...
    gs = _RAN.rand(z_pu./[10., 20., 30., 40., 50., 60., 70., 80.], 55)
    ...
    _IMP.drop_shunt_results(case1, result_path*"/eulvtf_shunt_only/", "_power_mult_$(power_mult)", sol, mn_data, scenario_id, shunt_resistive)
