...
timestep_set = find_most_loaded_timesteps(profiles, 200)[1:30]

for power_mult in [3.]
    run_impedance_estimation_ug_noshunt_30_load_case(raw"C:\Users\mvanin\OneDrive - KU Leuven\Desktop\repos\DataDrivenImpedanceEstimationWithCarson\paper_results/noiseless/", ie_solver, pf_solver, profiles, timestep_set, add_meas_noise = false, length_bounds_percval=0.3, power_mult=power_mult, exploit_squaredness = true, exploit_equal_crossection = true)
end
