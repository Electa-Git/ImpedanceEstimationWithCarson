...
ie_solver = _PMD.optimizer_with_attributes(Ipopt.Optimizer, "max_cpu_time" => 1800., "max_iter" => 8000,  "hsllib"=> HSL_jll.libhsl_path, "linear_solver" => "mumps")
...
function run_impedance_estimation_oh_ground_30_load_case(result_path::String, ie_solver, pf_solver, profiles::_DF.DataFrame, timestep_set; scenario_id::Int = 1, add_meas_noise::Bool=true, power_mult::Float64=1., use_length_bounds::Bool=true, length_bounds_percval::Float64=0.10, shunt_resistive::Bool=true, exploit_equal_crossection::Bool=false, exploit_horizontality::Bool=false)    
    ...
    _IMP.drop_results(case, result_path*"/30l_oh_most_restricted/", "_power_mult_$(power_mult)_", [], sol, mn_data, timestep_set, scenario_id, add_meas_noise, power_mult, false, false, false, use_length_bounds, length_bounds_percval, imp_est, imp_true, real_volts, real_vas, est_volts, est_vas, mn_data["nw"]["1"]["settings"]["exploit_equal_crossection"], mn_data["nw"]["1"]["settings"]["exploit_squaredness"], mn_data["nw"]["1"]["settings"]["exploit_horizontality"])
    _IMP.drop_shunt_results(case, result_path*"/30l_oh_most_restricted/", "_power_mult_$(power_mult)_", sol, mn_data, scenario_id, shunt_resistive)
    ...
    _IMP.drop_results(case, result_path*"/30l_oh_cross_only/", "_power_mult_$(power_mult)_", [], sol, mn_data, timestep_set, scenario_id, add_meas_noise, power_mult, false, false, false, use_length_bounds, length_bounds_percval, imp_est, imp_true, real_volts, real_vas, est_volts, est_vas, mn_data["nw"]["1"]["settings"]["exploit_equal_crossection"], mn_data["nw"]["1"]["settings"]["exploit_squaredness"], mn_data["nw"]["1"]["settings"]["exploit_horizontality"])
    _IMP.drop_shunt_results(case, result_path*"/30l_oh_cross_only/", "_power_mult_$(power_mult)_", sol, mn_data, scenario_id, shunt_resistive)
    ...
    _IMP.drop_results(case, result_path*"/30l_oh_horizontal_only/", "_power_mult_$(power_mult)_", [], sol, mn_data, timestep_set, scenario_id, add_meas_noise, power_mult, false, false, false, use_length_bounds, length_bounds_percval, imp_est, imp_true, real_volts, real_vas, est_volts, est_vas, mn_data["nw"]["1"]["settings"]["exploit_equal_crossection"], mn_data["nw"]["1"]["settings"]["exploit_squaredness"], mn_data["nw"]["1"]["settings"]["exploit_horizontality"])
    _IMP.drop_shunt_results(case, result_path*"/30l_oh_horizontal_only/", "_power_mult_$(power_mult)_", sol, mn_data, scenario_id, shunt_resistive)
    ...
    _IMP.drop_results(case, result_path*"/30l_oh_no_restriction/", "_power_mult_$(power_mult)_", [], sol, mn_data, timestep_set, scenario_id, add_meas_noise, power_mult, false, false, false, use_length_bounds, length_bounds_percval, imp_est, imp_true, real_volts, real_vas, est_volts, est_vas, mn_data["nw"]["1"]["settings"]["exploit_equal_crossection"], mn_data["nw"]["1"]["settings"]["exploit_squaredness"], mn_data["nw"]["1"]["settings"]["exploit_horizontality"])
    _IMP.drop_shunt_results(case, result_path*"/30l_oh_no_restriction/", "_power_mult_$(power_mult)_", sol, mn_data, scenario_id, shunt_resistive)
