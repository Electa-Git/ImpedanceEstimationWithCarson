...
for folder in ["30l_oh_noground_cross_only", "30l_oh_noground_horizontal_only", "30l_oh_noground_most_restricted", "30l_oh_noground_no_restriction", "eulvtf_oh_noground_cross_only", "eulvtf_oh_noground_horizontal_only", "eulvtf_oh_noground_most_restricted", "eulvtf_oh_noground_no_restriction"]#readdir(general_result_path)
    if isdir(joinpath(general_result_path, folder)) && occursin("oh", folder)
        ...
        if feeder_name == "30load-feeder"
            true_ground_shunts = raw"C:\Users\mvanin\OneDrive - KU Leuven\Desktop\repos\DataDrivenImpedanceEstimationWithCarson\results_ma27\30l_oh_most_restricted\_case30loads_oh_ground__shunts_scenario_1__power_mult_1.0__resistive_true.json"
            ...
            # true_ground_shunts = raw"C:\Users\mvanin\OneDrive - KU Leuven\Desktop\repos\DataDrivenImpedanceEstimationWithCarson\results_ma27\eulvtf_oh_no_restriction\_eulvtf_oh_ground__shunts_scenario_1__power_mult_1.0__resistive_true.json"
